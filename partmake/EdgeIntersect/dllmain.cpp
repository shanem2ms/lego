...
struct EdgePart
{
    ...
    bool Intersect(EdgePart b, Vector3& ipt)
    {
        Vector3 A, B, C, D;
        int xyzshuffle = 0;
        if (epsEq(e.dir.X, 0) && epsEq(b.e.dir.X, 0))
        {
            xyzshuffle = 1;
            A = Vector3(e.v0->Y, e.v0->Z, e.v0->X);
            B = Vector3(e.v1->Y, e.v1->Z, e.v1->X);
            C = Vector3(b.e.v0->Y, b.e.v0->Z, b.e.v0->X);
            D = Vector3(b.e.v1->Y, b.e.v1->Z, b.e.v1->X);
        }
        else if (epsEq(e.dir.Y, 0) && epsEq(b.e.dir.Y, 0))
        {
            xyzshuffle = 2;
            A = Vector3(e.v0->X, e.v0->Z, e.v0->Y);
            B = Vector3(e.v1->X, e.v1->Z, e.v1->Y);
            C = Vector3(b.e.v0->X, b.e.v0->Z, b.e.v0->Y);
            D = Vector3(b.e.v1->X, b.e.v1->Z, b.e.v1->Y);
        }
        else
        {
            A = *e.v0;
    ...
    OutIntersection *oi, int maxIntersections)
{
    ...
    {   
        /*
        if (!epsEq(i.e1.DistanceFromPt(i.pt), 0))
            __debugbreak();
        if (!epsEq(i.e2.DistanceFromPt(i.pt), 0))
            __debugbreak();
            */
        curOI->e1 = i.e1.idx;
        curOI->e2 = i.e2.idx;
